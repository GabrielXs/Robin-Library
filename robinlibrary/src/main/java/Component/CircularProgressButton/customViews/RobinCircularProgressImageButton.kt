...
import Component.CircularProgressButton.disposeAnimator
import Component.CircularProgressButton.presentation.ProgressButtonPresenter
...
open class RobinCircularProgressImageButton:AppCompatButton, RobinProgressButton{
    ...
    private val morphAnimator by lazy {
        AnimatorSet().apply {
            playTogether(
                ...
                widthAnimator(this@RobinCircularProgressImageButton, initialState.initialWidth, finalWidth),
                heightAnimator(this@RobinCircularProgressImageButton, initialHeight, finalHeight)
            )
    ...
    private val morphRevertAnimator by lazy {
        AnimatorSet().apply {
            playTogether(
                ...
                widthAnimator(this@RobinCircularProgressImageButton, finalWidth, initialState.initialWidth),
                heightAnimator(this@RobinCircularProgressImageButton, finalHeight, initialHeight)
            )
