...
open class RobinCircularProgressButton : AppCompatButton, RobinProgressButton {
    ...
    private val morphAnimator by lazy {
        AnimatorSet().apply {
            playTogether(
                ...
                widthAnimator(this@RobinCircularProgressButton, initialState.initialWidth, finalWidth),
                heightAnimator(this@RobinCircularProgressButton, initialHeight, finalHeight)
            )
    ...
    private val morphRevertAnimator by lazy {
        AnimatorSet().apply {
            playTogether(
                ...
                widthAnimator(this@RobinCircularProgressButton, finalWidth, initialState.initialWidth),
                heightAnimator(this@RobinCircularProgressButton, finalHeight, initialHeight)
            )
